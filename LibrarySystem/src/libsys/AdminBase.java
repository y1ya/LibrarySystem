...
public class AdminBase extends main {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Reader", "Librarian", "Admin" }));
        jComboBox1.setSelectedIndex(-1);

        listAccounts.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_INTERVAL_SELECTION);
    ...
    private void listAccountsValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_listAccountsValueChanged
        ...
        try 
        {
            rs = stmt.executeQuery("SELECT FULLNAME FROM ACCOUNTS");
            while (rs.next()) 
            {
